...
(unless (package-installed-p 'lombok-mode)
  (package-refresh-contents)
  (package-install 'lombok-mode))

(add-hook 'java-mode-hook #'lombok-mode)
...
(use-package lsp-java 
	...
	(setq lsp-java-vmargs
		  (list
		   ...
		   "-javaagent:/Users/srivigneshmurugesan/.m2/repository/org/projectlombok/lombok/1.18.28/lombok-1.18.28.jar")))

(setq lsp-java-vmargs (list "-noverify" "-Xmx1G" "-XX:+UseG1GC" "-XX:+UseStringDeduplication" "-javaagent:/Users/srivigneshmurugesan/.m2/repository/org/projectlombok/lombok/1.18.28/lombok-1.18.28.jar"))
